...
- **Use the approved regular dual-meet window for live meet state.** Standard CNSL regular dual meets run from 8:00 AM through 12:00 PM Eastern so pools can reopen for general public use at noon; live `Upcoming`/`Ongoing` state may use that window. Do not apply this convention to Time Trials, All-City, or other special meets unless their timing is explicitly modeled from an approved source.
