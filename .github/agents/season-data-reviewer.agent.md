...
description: "Reviews changed official seasonal sources, resolves source authority and confidence, and prepares annual application-data updates only when modeled data changed."
