...
description: "Prepare, audit, or activate annual CNSL assets for pools, meets, and teams. Use when asked to add a swim season, review source authority or conflicts, download official PDFs, create year-specific JSON or schemas, update the active YEAR, check missing annual data, or perform a season rollover."
