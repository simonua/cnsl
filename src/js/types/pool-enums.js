...
if (typeof window === 'undefined' || !window.PoolStatus) {
  class PoolStatus {
    ...
    static PRACTICE_ONLY = Object.freeze({ kind: 'practice-only', isOpen: true, status: 'Practice Only', color: 'yellow' });
    static CLOSED_TO_PUBLIC = Object.freeze({ kind: 'closed-to-public', isOpen: false, status: 'Closed to Public', color: 'red' });
