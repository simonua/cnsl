...
if (typeof globalThis.IconCatalog === 'undefined') {
  const ICON_NAMES = new Set([
    'accessibility', 'banknote', 'book-open', 'calendar', 'clipboard-list', 'clock', 'cookie', 'cup-soda', 'facebook', 'globe',
    'home', 'info', 'mail', 'map', 'map-pin', 'message-circle', 'moon',
    'phone', 'pool', 'qr-code', 'runner', 'settings', 'shirt', 'shirt-plus',
    'stopwatch', 'sun', 'swimmer', 'trophy', 'utensils', 'warning-triangle', 'x-brand'
  ]);
