...
(function initializeAppConfig(globalScope) {
  ...
  const APP_LAST_UPDATED_ON = '2026-06-26';
  ...
  const OFFICIAL_SOURCE_CHECKED_AT = '2026-06-25T21:47:16-04:00';
  const OFFICIAL_SOURCE_UPDATED_AT = '2026-06-24T07:23:33-04:00';
