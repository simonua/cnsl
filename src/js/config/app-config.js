...
(function initializeAppConfig(globalScope) {
  ...
  const OFFICIAL_SOURCE_CHECKED_AT = '2026-07-01T16:19:26-04:00';
  const OFFICIAL_SOURCE_UPDATED_AT = '2026-07-01T16:19:26-04:00';
  ...
  const WEATHER_ALERT_STATUS_CHANGED_EVENT_NAME = 'cnsl:weather-alert-status-changed';
  ...
  const ANALYTICS_APP_MODE_REPORTED_STORAGE_KEY = 'cnsl_analytics_app_mode_reported';
  ...
  const WELCOME_DIALOG_NAVIGATION_SUPPRESSED_STORAGE_KEY = 'cnsl_welcome_dialog_navigation_suppressed';
  ...
  const RUNTIME_CONFIG = Object.freeze({
    ...
    WEATHER_ALERT_LAST_SUCCESSFUL_CHECK_STORAGE_KEY,
    WEATHER_ALERT_STATUS_CHANGED_EVENT_NAME,
    WEATHER_ALERT_STATUS_STORAGE_KEY,
