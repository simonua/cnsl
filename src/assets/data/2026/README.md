...
**Last accepted official-source check:** 2026-06-04. This accepted review date is published in the FAQ and footer through `OFFICIAL_SOURCE_CHECKED_AT` in `src/js/config/app-config.js`; update both records together after a reviewed official-source refresh or check changes accepted application data.
