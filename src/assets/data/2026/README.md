...
- Lane counts were added for all 23 pools from the provided 2026 pool lane inventory on 2026-05-28. On 2026-05-29, a corrected provided lane inventory supplied course measurement and 25-unit lengths for all pools except Hobbit's Glen, whose known `yards` measurement is retained with an unspecified length.
