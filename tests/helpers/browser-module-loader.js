...
const BROWSER_MODULE_MANIFESTS = Object.freeze({
  ...
  pool: { scripts: [CONFIG, ICONS, TIME, 'types/pool-enums.js', SCHEDULE_STATE, 'services/pool-period-schedule-service.js', 'models/pool.js'], exports: ['Pool', 'PoolStatus', 'TimeUtils', 'PoolPeriodScheduleService'], realmExports: ['PoolStatus'] },
  ...
  'pool-link-helper': { scripts: [CONFIG, 'services/html-safety.js', ICONS, 'services/device-platform-service.js', 'services/pool-link-helper.js'], exports: ['createPoolLocationIndex', 'formatPoolCourseLabel', 'generateEnhancedPoolLink', 'generateGoogleMapsLink', 'generateLinkedPoolMentions', 'generatePoolDirectionsLink', 'generatePoolsPageLink', 'getPoolDataFromLocation', 'getPoolDirectionsQuery', 'getPoolIdFromLocation'] },
  ...
  'weather-alert-cache-service': { scripts: [CONFIG, WEATHER_HAZARD, WEATHER_SOURCE, 'services/weather-freshness-service.js'], exports: ['WeatherAlertCacheService', 'WeatherAlertSource'], realmExports: ['WeatherAlertSource'] },
